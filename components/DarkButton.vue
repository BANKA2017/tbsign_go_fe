<template>
    <button class="aspect-square rounded-xl tex-3xl transition-colors bg-gray-200 hover:bg-gray-300 text-gray-900 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-100" @click="switchDarkModeProxy">
        <!--auto-->
